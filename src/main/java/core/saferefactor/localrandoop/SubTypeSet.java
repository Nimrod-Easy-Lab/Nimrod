...
import saferefactor.localrandoop.util.IMultiMap;
...
import saferefactor.localrandoop.util.SimpleSet;

/**
 * A set of classes. This data structure additionally allows for
 * efficient answers to queries about can-be-used-as
 * ({@link saferefactor.localrandoop.util.Reflection#canBeUsedAs(Class,Class)})
 *  relationships.
 */
